...
import { OutDeclarationInfo } from '../dashtable';
import { getLocalStorage } from '../../../components/localstorage';


export const CheckModal = ({ isOpen, onRequestClose, outdeclarationDetails, onSubmit }) => {
        ...
        style={{
         ...
         <div className="container mt-4">
            ...
            <div className="text-center">
                ...
                <button className="btn btn-primary mx-4" onClick={handleSubmit}>确认审核</button>
            </div>
        </div>
    </Modal>
    );
